...
public class FilterKernelPanel extends JPanel implements ObserverIF {
	...
	private void setFilter(String string) {
		...
		switch (index) {
			case 1: // Mean filter
			{
				float meanKernel[][] = {{1/9f, 1/9f, 1/9f},
										{1/9f, 1/9f, 1/9f},
										{1/9f, 1/9f, 1/9f}};
			...
			{
				float meanKernel[][] = {{1/16f, 2/16f, 1/16f},
										{2/16f, 4/16f, 2/16f},
										{1/16f, 2/16f, 1/16f}};
				_kernelPanel.setKernelValues(meanKernel);
			} 
