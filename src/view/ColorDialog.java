...
public class ColorDialog extends JDialog {
	...
	private JPanel createCMYKPanel(ColorDialogResult result, int imageWidths) {	
		...
		JPanel panel = new JPanel();
		panel.setLayout(new BoxLayout(panel, BoxLayout.Y_AXIS));
		ColorSlider csCyan = new ColorSlider("C:", (int) (255 * cmykMediator.getCyan()), cmykMediator.getCyanImage());
		ColorSlider csMagenta = new ColorSlider("M:", (int) (255 * cmykMediator.getMagenta()), cmykMediator.getMagentaImage());
		ColorSlider csYellow = new ColorSlider("Y:", (int) (255 * cmykMediator.getYellow()), cmykMediator.getYellowImage());
		ColorSlider csBlack = new ColorSlider("K:", (int) (255 * cmykMediator.getBlack()), cmykMediator.getBlackImage());
